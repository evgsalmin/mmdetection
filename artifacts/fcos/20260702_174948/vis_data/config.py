...
default_hooks = dict(
    checkpoint=dict(
        interval=1, max_keep_ckpts=3, rule='greater', type='CheckpointHook'),
...
test_evaluator = dict(
    ann_file='datasets/minecraft/annotations/test_annotations.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='datasets/minecraft/annotations/valid_annotations.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
